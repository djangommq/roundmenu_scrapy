...
import os
import pymongo
from roundmenu_scrapy.utils import MONGODB_SERVER, MONGODB_PORT, MONGODB_DATABASE, USER, PASSWORD, DATA
import logging
...
class Mongodb(object):
    ...
    # 修改
    def update_one(self, collection_name, query, form, upsert):
